...
|----------|----------|------|-------|
| admin | Admin@01 | admin | admin@example.com |
...
### TC-1.03: Signup Username Required
**Parent Use Case:** [UC-1.2: Register New User](USE-CASES.md#uc-12-register-new-user)
...
### TC-1.05: Signup Password Minimum Length
**Parent Use Case:** [UC-1.2: Register New User](USE-CASES.md#uc-12-register-new-user)
...
### TC-1.06: Signup Duplicate Username Prevention
**Parent Use Case:** [UC-1.2: Register New User](USE-CASES.md#uc-12-register-new-user)
...
### TC-1.07: Signup Duplicate Email Prevention
**Parent Use Case:** [UC-1.2: Register New User](USE-CASES.md#uc-12-register-new-user)
...
### TC-1.08: Signup Username Case Insensitivity
**Parent Use Case:** [UC-1.2: Register New User](USE-CASES.md#uc-12-register-new-user)

**Objective:** Verify usernames are matched case-insensitively.
...
### TC-1.09: Login Page UI Elements
...
### TC-1.10: Login Successful Authentication
...
### TC-1.11: Login Invalid Password
**Parent Use Case:** [UC-1.4: Authenticate User](USE-CASES.md#uc-14-authenticate-user)
...
### TC-1.12: Login Invalid Username
**Parent Use Case:** [UC-1.4: Authenticate User](USE-CASES.md#uc-14-authenticate-user)
...
### TC-1.13: Login Username Case Insensitivity
**Parent Use Case:** [UC-1.4: Authenticate User](USE-CASES.md#uc-14-authenticate-user)
...
### TC-1.14: Login Empty Credentials
**Parent Use Case:** [UC-1.4: Authenticate User](USE-CASES.md#uc-14-authenticate-user)
...
### TC-1.16: Protected Route Unauthenticated
...
### TC-1.17: Protected Route Authenticated
**Parent Use Case:** [UC-1.4: Authenticate User](USE-CASES.md#uc-14-authenticate-user)
...
### TC-1.18: Navigation Between Auth Pages
...
### TC-1.19: User Enumeration Prevention
**Parent Use Case:** [UC-1.4: Authenticate User](USE-CASES.md#uc-14-authenticate-user)
...
### TC-1.20: Form Input Sanitization
**Parent Use Case:** [UC-1.2: Register New User](USE-CASES.md#uc-12-register-new-user)
...
- [ ] Entry removed from list
- [ ] List updated immediately
- [ ] Associated UserLogin (if any) also deleted
