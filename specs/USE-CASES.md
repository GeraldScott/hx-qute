...
| LOGIN.md | Authentication technical specification |
...
**Parent Story:** [US-1.1: User Registration](USER-STORIES.md#us-11-user-registration)
...
**Main Flow:**
1. System displays signup form with fields: username, email, password
...
**Parent Story:** [US-1.2: User Login](USER-STORIES.md#us-12-user-login)
...
**Main Flow:**
1. System displays login form with fields: username, password
...
4. System normalizes username to lowercase
5. System looks up UserLogin by username
6. System verifies password against stored hash
7. System checks account is not locked
8. System records successful login (resets failed attempts)
9. System creates authenticated session
10. System redirects to home page with personalized greeting

**Alternative Flows:**

| ID | Condition | Action |
|----|-----------|--------|
| 5a | Username not found | Display "Invalid username or password" (generic) |
| 6a | Password incorrect | Increment failed attempts; display "Invalid username or password" |
| 7a | Account locked | Display "Account is locked. Try again later." |
| 6b | Failed attempts >= 5 | Lock account for 15 minutes (progressive) |
...
### UC-1.5: Logout User
**Parent Story:** [US-1.3: User Logout](USER-STORIES.md#us-13-user-logout)
...
1. System displays confirmation dialog
2. User confirms deletion
3. System deletes Person record (cascades to UserLogin if exists)
